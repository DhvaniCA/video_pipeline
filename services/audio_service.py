...
# ============================================================
# Male Instructor  → ElevenLabs "Rahul"  (Indian English male)
# Female Student   → ElevenLabs "Priya"  (Indian English female)

# Falls back to alternative Indian-accent voices automatically.
# """
...
# # ---------------------------------------------------------------------------
# # ElevenLabs Voice IDs — Indian-accent voices
# # ---------------------------------------------------------------------------
# # Primary choices (high quality, Indian accent):
# #   "Rahul"  — Indian English male   — voice_id: "TX3LPaxmHKxFdv7VOQHJ"
# #   "Priya"  — Indian English female — voice_id: "EXAVITQu4vr4xnSDxMaL"
# #
# # If the above IDs change, replace them here:
# _VOICE_MALE   = os.getenv("ELEVENLABS_VOICE_MALE",   "TX3LPaxmHKxFdv7VOQHJ")  # Rahul
# _VOICE_FEMALE = os.getenv("ELEVENLABS_VOICE_FEMALE", "EXAVITQu4vr4xnSDxMaL")  # Sarah (fallback)

# # Alternative Indian male: "29vD33N1CtxCmqQRPOHJ" (Drew), female: "XB0fDUnXU5powFXDhCwa" (Charlotte)
# # For best Indian accent experience, configure via ElevenLabs dashboard and set env vars above.

# _ELEVENLABS_MODEL = "eleven_multilingual_v2"  # supports Hinglish/Hindi words well
# _INTER_SEGMENT_PAUSE_MS = 350   # ms of silence between speaker turns
# _INTRA_SEGMENT_PAUSE_MS = 120   # ms of silence at natural sentence breaks
...
#         User A: Rahul ka dialogue yahan...
#         User B: Priya ka dialogue yahan...
#     """
...
#         User A → Male Indian instructor voice
#         User B → Female Indian student voice
#         """
#         try:
...
#                 text    = seg["text"]
#                 voice   = _VOICE_MALE if speaker == "A" else _VOICE_FEMALE
...
#                 ok = self._generate_segment_elevenlabs(text, voice, seg_path)
#                 if not ok:
#                     # fallback to OpenAI
#                     oai_voice = "onyx" if speaker == "A" else "nova"
#                     ok = self._generate_segment_openai(text, oai_voice, seg_path)
#                 if not ok:
...
#                     final_audio += seg_audio + silence_between
...
#             print("  🎙️  User A → Instructor  (ElevenLabs Indian Male)")
#             print("  🎙️  User B → Student     (ElevenLabs Indian Female)")
...
#     def _generate_segment_elevenlabs(self, text: str, voice_id: str, output_path: str) -> bool:
#         """
#         Generate a single audio segment using ElevenLabs.
#         Uses eleven_multilingual_v2 model for proper Hinglish support.
#         """
...
#                 voice_settings={
#                     "stability": 0.55,          # slight variation for natural Hinglish
#                     "similarity_boost": 0.80,   # stay close to target voice
#                     "style": 0.25,              # mild expressiveness
...
#         """Fallback: generate segment via OpenAI TTS."""
